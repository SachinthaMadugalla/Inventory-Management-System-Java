...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .summary-pill{display:inline-flex;align-items:center;gap:8px;padding:10px 18px;background:rgba(0,0,0,.03);border:1px solid var(--bd2);border-radius:999px;font-family:'Syne',sans-serif;font-weight:700;font-size:14px;}
        .summary-pill.is-red{color:var(--red);border-color:rgba(221,75,57,.3);}
        .summary-pill.is-amber{color:var(--amber);border-color:rgba(243,156,18,.3);}
