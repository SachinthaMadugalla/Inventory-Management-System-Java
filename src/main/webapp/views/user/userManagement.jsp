...
<c:set var="activePage" value="userManagement" scope="request"/>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>User Management — Lumenara</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .badge.bg-primary { background:var(--v-dim) !important; color:var(--violet) !important; border:1px solid var(--bdv); }
        ...
        <div class="topbar">
            <div class="topbar-header">
                ...
                <div>
                    ...
                    <p class="topbar-sub d-none d-sm-block">View and manage system users.</p>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form action="${pageContext.request.contextPath}/deleteUser" method="post" class="d-inline"
                                        ...
                                        <button type="submit" class="btn btn-sm btn-outline-danger" ${u.username == sessionScope.username ? 'disabled' : ''}>
